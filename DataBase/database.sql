...
INSERT into PERSONAL_CARD (name,surname,gender,language,birthdate,dninie,province,comarca,address,type_house,ownership,phone,mobile_phone) VALUES ("Jordi","Martinez Garcia","Home",2,"1992-05-12","68951118Q",1,14,"carrer fals 123","casa",2,"9345625538","622856794");

/*Insert STA for the client by default*/
INSERT into STA (user_dninif, actual_situation, hiring_date, tf_service, tcr_service, cc_service, tm_service, tam_service, gps_service, umt_service) VALUES ("68951118Q","Alta","2019-05-12",0,1,1,0,1,1,1);
