<?php
  ...
  $consulta="INSERT INTO CALL_HISTORY (user_dninif,call_date, call_type, call_state, teleoperator_solution, reason_for_advice, description, Destiny_advice) VALUES ('".$sDniNif."','".$sCallDate."','".$iCallType."','".$iCallState."','".$sTeleoperatorSolution."','".$sReasonAdvice."','".$sDescription."','".$sDestinyAdvice."')";
