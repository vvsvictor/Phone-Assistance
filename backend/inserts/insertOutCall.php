...
$consulta="INSERT INTO CALL_HISTORY (user_dninif,call_date, call_type, outcall_type, call_state, teleoperator_solution, reason_for_advice, description, Destiny_advice) VALUES ('".$sDniNif."','".$sCallDate."','".$iCallType."','".$iOutcallType."','".$iCallState."','".$sTeleoperatorSolution."','".$sReasonAdvice."','".$sDescription."','".$sDestinyAdvice."','".$absence_date."','".$return_date."','".$other."')";
